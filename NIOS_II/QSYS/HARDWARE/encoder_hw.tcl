...
set_fileset_property QUARTUS_SYNTH TOP_LEVEL encoder_top
set_fileset_property QUARTUS_SYNTH ENABLE_RELATIVE_INCLUDE_PATHS false
set_fileset_property QUARTUS_SYNTH ENABLE_FILE_OVERWRITE_MODE false
add_fileset_file encoder.v VERILOG PATH ../../RTL/encoder.v
add_fileset_file encoder_reg.v VERILOG PATH ../../RTL/encoder_reg.v
add_fileset_file encoder_top.v VERILOG PATH ../../RTL/encoder_top.v TOP_LEVEL_FILE
...
add_interface_port conduit_end encoder_sginal encoder_sginal Input 1
...
add_interface_port avalon_slave_0_1 avs_address address Input 8
add_interface_port avalon_slave_0_1 avs_write write Input 1
add_interface_port avalon_slave_0_1 avs_write_data writedata Input 32
add_interface_port avalon_slave_0_1 avs_read read Input 1
add_interface_port avalon_slave_0_1 avs_read_data readdata Output 32
